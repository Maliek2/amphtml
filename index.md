...
<html ⚡="">
  <head>
    ...
    <link
      rel="canonical"
      href="https://www.ampstart.com/templates/gallery.amp"
    />
  ...
  <body>
    ...
    >
      ...
      >
        <svg
          ...
          height="36"
        >
          <path fill="currentColor" d="M9 12h18v1H9z"></path>
          <path fill="currentColor" d="M9 17h18v1H9z"></path>
          <path fill="currentColor" d="M9 22h18v1H9z"></path>
        </svg>
      </div>
    </header>
      ...
      <nav class="ampstart-sidebar-nav ampstart-nav">
        <ul class="list-reset m0 p0 ampstart-label">
          ...
          <li class="ampstart-nav-item gallery-sidebar-nav-item">
            <a class="ampstart-nav-link" href="./gallery.amp.html"
          ...
          <li class="ampstart-nav-item gallery-sidebar-nav-item">
            <a class="ampstart-nav-link" href="./gallery-inner.amp.html"
              ><div class="gallery-sidebar-nav-item-text">
                Untitled<br />Evan Ondre
              </div>
              <amp-img
                class="gallery-sidebar-nav-item-image"
                width="1"
                height="1"
                layout="responsive"
                src="../img/gallery/smoke.jpg"
                srcset="../img/gallery/smoke.jpg 1x, ../img/gallery/smoke@2x.jpg 2x"
              ></amp-img>
              <div class="gallery-sidebar-nav-item-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                  <polyline
          ...
          <li class="ampstart-nav-item gallery-sidebar-nav-item">
            <a class="ampstart-nav-link" href="./gallery-inner.amp.html"
              ...
              <amp-img
                ...
                height="1"
                layout="responsive"
                src="../img/gallery/court.jpg"
                srcset="../img/gallery/court.jpg 1x, ../img/gallery/court@2x.jpg 2x"
              ></amp-img>
              <div class="gallery-sidebar-nav-item-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                  <polyline
          ...
          <li class="ampstart-nav-item gallery-sidebar-nav-item">
            <a class="ampstart-nav-link" href="./gallery-inner.amp.html"
              ...
              <amp-img
                ...
                height="1"
                layout="responsive"
                src="../img/gallery/orange.jpg"
                srcset="../img/gallery/orange.jpg 1x, ../img/gallery/orange@2x.jpg 2x"
              ></amp-img>
              <div class="gallery-sidebar-nav-item-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                  <polyline
          ...
          <li class="ampstart-nav-item gallery-sidebar-nav-item">
            <a class="ampstart-nav-link" href="./gallery-inner.amp.html"
              ...
              <amp-img
                ...
                height="1"
                layout="responsive"
                src="../img/gallery/lamp.jpg"
                srcset="../img/gallery/lamp.jpg 1x, ../img/gallery/lamp@2x.jpg 2x"
              ></amp-img>
              <div class="gallery-sidebar-nav-item-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                  <polyline
          ...
          <li class="ampstart-nav-item gallery-sidebar-nav-item">
            <a class="ampstart-nav-link" href="./gallery-inner.amp.html"
              ><div class="gallery-sidebar-nav-item-text">
                Geo Breakfast<br />Terra Morales
              </div>
              <amp-img
                class="gallery-sidebar-nav-item-image"
                width="1"
                ...
                srcset="../img/gallery/balloon.jpg 1x, ../img/gallery/balloon@2x.jpg 2x"
              ></amp-img>
              <div class="gallery-sidebar-nav-item-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                  <polyline
          ...
          <li class="ampstart-nav-item gallery-sidebar-nav-item">
            <a class="ampstart-nav-link" href="./gallery-inner.amp.html"
              ><div class="gallery-sidebar-nav-item-text">
                Flower Still Life<br />Brad Parker
              </div>
              <amp-img
                class="gallery-sidebar-nav-item-image"
                width="1"
                ...
                srcset="../img/gallery/plant.jpg 1x, ../img/gallery/plant@2x.jpg 2x"
              ></amp-img>
              <div class="gallery-sidebar-nav-item-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                  <polyline
    ...
    <div class="gallery-component-tagline xs-hide">
      <div>Gallery of Modern Art</div>
    </div>
    <main id="content" class="gallery-base-content fit" role="main">
      <h1
        class="gallery-landing-title flex justify-center items-center center absolute top-0 left-0 right-0 z1 mx-auto gallery-base-invert"
      >
      ...
      <amp-carousel
        ...
        height="100vh"
        controls=""
        class="gallery-landing-wall block relative"
      >
        <div class="gallery-landing-wall-scroll relative">
          <figure
            class="gallery-landing-image-wrapped gallery-landing-image-wrap"
          >
            <a
              href="./gallery-inner.amp.html"
              class="gallery-landing-image-link"
            ></a>
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-bottom gallery-landing-image-caption-extraleft gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Modern Caesar</h2>
              <h3 class="h4 regular" role="author">Sylvia Johnson</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
              >
            </figcaption>
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                layout="responsive"
                noloading=""
                src="../img/gallery/chair.jpg"
                srcset="
          ../img/gallery/chair.jpg 1x,
          ../img/gallery/chair@2x.jpg 2x
        "
                alt="wooden chair"
              ></amp-img>
            </div>
          ...
          >
            ...
            ></a>
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-bottom gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Living Tree</h2>
              <h3 class="h4 regular" role="author">David Beck</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                src="../img/gallery/orange.jpg"
                srcset="
          ../img/gallery/orange.jpg 1x,
          ../img/gallery/orange@2x.jpg 2x
        "
                alt="orange painted blue"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            ></a>
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-right gallery-landing-image-caption-bottom gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Flower Still Life</h2>
              <h3 class="h4 regular" role="author">Brad Parker</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                src="../img/gallery/plant.jpg"
                srcset="
          ../img/gallery/plant.jpg 1x,
          ../img/gallery/plant@2x.jpg 2x
        "
                alt="house plant on a chair"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-bottom gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">The Way Out</h2>
              <h3 class="h4 regular" role="author">Janet Lande</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                layout="responsive"
                noloading=""
                src="../img/gallery/hall.jpg"
                srcset="
          ../img/gallery/hall.jpg 1x,
          ../img/gallery/hall@2x.jpg 2x
        "
          ...
          >
            ...
            ></a>
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Short Circuit</h2>
              <h3 class="h4 regular" role="author">Anna Moss</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                src="../img/gallery/lamp.jpg"
                srcset="
          ../img/gallery/lamp.jpg 1x,
          ../img/gallery/lamp@2x.jpg 2x
        "
                alt="pink outdoor lamp"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            ></a>
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-extraleft gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Untitled</h2>
              <h3 class="h4 regular" role="author">Evan Ondre</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                src="../img/gallery/smoke.jpg"
                srcset="
          ../img/gallery/smoke.jpg 1x,
          ../img/gallery/smoke@2x.jpg 2x
        "
                alt="pink smoke"
              ></amp-img>
            </div>
          ...
          >
            ...
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Spiraling Industry</h2>
              <h3 class="h4 regular" role="author">David Alders</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                layout="responsive"
                noloading=""
                src="../img/gallery/spiral.jpg"
                srcset="
          ../img/gallery/spiral.jpg 1x,
          ../img/gallery/spiral@2x.jpg 2x
        "
                alt="spiraling staircase"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Palm Tree Dreams</h2>
              <h3 class="h4 regular" role="author">Janet Lande</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                layout="responsive"
                noloading=""
                src="../img/gallery/stairs.jpg"
                srcset="
          ../img/gallery/stairs.jpg 1x,
          ../img/gallery/stairs@2x.jpg 2x
        "
                alt="pink residential building with outdoor staircase"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-bottom gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">No Name</h2>
              <h3 class="h4 regular" role="author">Tan Howell</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                srcset="
          ../img/gallery/spectrum.jpg 1x,
          ../img/gallery/spectrum@2x.jpg 2x
        "
                alt="striped colours"
              ></amp-img>
            </div>
          ...
          >
            ...
            ></a>
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-bottom gallery-landing-image-caption-right gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Flora and Illuminations</h2>
              <h3 class="h4 regular" role="author">Steven Rice</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                layout="responsive"
                noloading=""
                src="../img/gallery/cactus.jpg"
                srcset="
          ../img/gallery/cactus.jpg 1x,
          ../img/gallery/cactus@2x.jpg 2x
        "
                alt="pink cactus"
              ></amp-img>
            </div>
          ...
          >
            ...
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-bottom gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Fluid Architecture</h2>
              <h3 class="h4 regular" role="author">Steven Rice</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                layout="responsive"
                noloading=""
                src="../img/gallery/corner.jpg"
                srcset="
          ../img/gallery/corner.jpg 1x,
          ../img/gallery/corner@2x.jpg 2x
        "
                alt="corner of white building&#39;s exterior"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Upward Perspective</h2>
              <h3 class="h4 regular" role="author">Momo Reid</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                layout="responsive"
                noloading=""
                src="../img/gallery/building.jpg"
                srcset="
          ../img/gallery/building.jpg 1x,
          ../img/gallery/building@2x.jpg 2x
        "
                alt="black and white building"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            >
              <h2 class="h4 regular">Untitled</h2>
              <h3 class="h4 regular" role="author">Von West</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                layout="responsive"
                noloading=""
                src="../img/gallery/skyline.jpg"
                srcset="
          ../img/gallery/skyline.jpg 1x,
          ../img/gallery/skyline@2x.jpg 2x
        "
                alt="sunset showing a skyline"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-bottom gallery-landing-image-caption-right gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Geo Breakfast</h2>
              <h3 class="h4 regular" role="author">Terra Morales</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                src="../img/gallery/balloon.jpg"
                srcset="
          ../img/gallery/balloon.jpg 1x,
          ../img/gallery/balloon@2x.jpg 2x
        "
                alt="colourful hot air balloon paneling"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Alternative Reality</h2>
              <h3 class="h4 regular" role="author">Nathaniel Hall</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                layout="responsive"
                noloading=""
                src="../img/gallery/lake.jpg"
                srcset="
          ../img/gallery/lake.jpg 1x,
          ../img/gallery/lake@2x.jpg 2x
        "
                alt="sunrise against a pink lake"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Cage</h2>
              <h3 class="h4 regular" role="author">Ellen Doe</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                src="../img/gallery/court.jpg"
                srcset="
          ../img/gallery/court.jpg 1x,
          ../img/gallery/court@2x.jpg 2x
        "
          ...
          >
            ...
            <figcaption
              class="gallery-landing-image-caption gallery-landing-image-caption-bottom gallery-landing-image-caption-right gallery-landing-image-caption-content"
            >
              <h2 class="h4 regular">Swimming in Neon</h2>
              <h3 class="h4 regular" role="author">Kay Herrera</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                srcset="
          ../img/gallery/jellyfish.jpg 1x,
          ../img/gallery/jellyfish@2x.jpg 2x
        "
                alt="pink jellyfish in a purple ocean"
              ></amp-img>
            </div>
          </figure>
          <figure
          ...
          >
            ...
            >
              <h2 class="h4 regular">Untitled</h2>
              <h3 class="h4 regular" role="author">Ian Jimenez</h3>
              <a
                href="./gallery-inner.amp.html"
                class="gallery-landing-caption-link inline-block"
                >View Exhibit</a
            ...
            <div class="gallery-landing-image-transform">
              <amp-img
                ...
                layout="responsive"
                noloading=""
                src="../img/gallery/stripe.jpg"
                srcset="
          ../img/gallery/stripe.jpg 1x,
          ../img/gallery/stripe@2x.jpg 2x
        "
                alt="black and white striped pattern"
              ></amp-img>
            </div>
          </figure>
        </div>
